---
title: "Move File"
description: "Files can be moved from one folder to another within the same Drive. A new file metadata transaction is created when a user wants to move a file into a different folder. The new file metadata trans…"
