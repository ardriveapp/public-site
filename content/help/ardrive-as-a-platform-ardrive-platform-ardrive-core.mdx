---
title: "Ardrive Core"
description: "What is ArDrive Core? ArDrive Core contains the essential back end features for the ArDrive apps, written in Typescript. While the Arweave network gives the power of immutable data storage, the ArD…"
