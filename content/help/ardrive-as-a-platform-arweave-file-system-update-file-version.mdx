...
description: "When a user adds a new file to a folder, and there is a file in that folder with the same name, then a new file version is created. A new file version uses the same File-Id of the file with the mat…"
