...
```
{
    "description": "Brief description of the NFT",
        "image": "https://turbo-gateway.com//digitalAsset.png",
        "name": "CrypToadz #10",
        "attributes": [
        {
...
```
{
    ...
    "image": "https://turbo-gateway.com/gjAzfpcJcHqviSnYuUI5ElEQT9b934ShxrUQ-WVolZ0/10.png",
    "name": "CrypToadz #10",
    "attributes": [
        {
...
3.  Get the JSON data for the file that was uploaded in step 1 by going to the following URL: [https://turbo-gateway.com/TransactionID](https://turbo-gateway.com/TransactionID) (where Transaction/ID is transaction ID returned from the `upload-file` command in step 1.)
...
7.  Once the transactions have completed from Step 6 you can search for the MetadataGqlTags you updated in your file out at: [https://turbo-gateway.com/graphql](https://turbo-gateway.com/graphql)
...
You can see this in action by running the following query out at [https://turbo-gateway.com/graphql](https://turbo-gateway.com/graphql)
