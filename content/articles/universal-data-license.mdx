...
To see the discoverability features in action we can also perform a GQL query to see that our metadata has been added as well.  We will go out to [GraphQL Playground](https://arweave.net/graphql) and issue the following query:
