...
> Initially, we uploaded the initial batch of ten thousand metadata JSON files and PNG image files using Wander and the Bundlr CLI tool. This allowed us to pay upfront for the entire upload, automatically create the necessary manifest files, and utilize various tokens, including AR, Ether, and Matic, for payment.
> 
