...
function generateLlmsTxt(articles) {
  ...
  const lines = [
    ...
    `- [About](${BASE_URL}/about/): What ArDrive is and who builds it.`,
    ...
    `- [Enterprise](${BASE_URL}/enterprise/): Permanent storage for organizations.`,
    `- [Articles](${BASE_URL}/articles/): Guides and announcements.`,
