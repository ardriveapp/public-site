...
export interface AboutHeroBackgroundVideoProps {
  className?: string;
}
...
const CROSSFADE_LEAD_TIME = 2.0;

export function AboutHeroBackgroundVideo({ className }: AboutHeroBackgroundVideoProps) {
  ...
  const videoSrc = withBasePath("/about/hero-animated-balloon.mp4");
  const posterSrc = withBasePath("/about/hero-clouds.jpg");
